...
深夜最难的不是「不知道要睡」，而是**关不掉电脑**：再回一条消息、再开一个 tab，时间就滑走了。

猫猫困了换了一个更好接受的约束——**不是系统在罚你，而是一只猫真的来你屏幕上睡觉**。你会更愿意把电脑让出来；到点也会真的锁得住（全屏、多显示器、覆盖层异常退出会重新拉起）。
...
第一次使用走的是**领养流程**：你填猫猫几点睡、几点走、每周哪几天来，还要签一句「我愿意让猫猫好好休息」。这是在建立一种小小的承诺，比冷冰冰的「启用屏幕锁定」更容易坚持。

### 温柔地靠近，再坚决地锁住

到睡前会先**打哈欠、发通知、慢慢降亮度和音量**——给你几分钟收尾，而不是突然黑屏。等真正到点，猫猫才登场接管屏幕。

### 锁屏动画的三幕（`cat-bedtime.mov`）

到点后全屏播放一段透明背景的猫猫动画，每一幕都在说人话：

| 画面 | 含义 |
| --- | --- |
| **猫猫拖着床来了** | 到点了，该睡了——它带着床来你的屏幕「住下」 |
| **猫猫拉绳子关灯** | 灯灭了，**锁屏开始**——从现在起这台电脑是猫猫的 |
| **猫猫躺下睡觉** | 猫猫要好好休息；**你也该休息了，别再碰电脑** |

动画播完后，猫猫会一直睡在屏幕上，直到你设定的起床时间。左上角有倒计时和一句「嘘，猫猫睡了」——提醒这不是故障，是在守夜。

### 可以请假，但要说明原因

`zzz tonight off` 或 App 里的「晚点再来」——猫猫不是暴君，但需要你跟它说一声为什么今晚例外。
...
| [RELEASE.md](RELEASE.md) | 打包、签名、公证 |
